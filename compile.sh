 ...
 make image PROFILE=psg1218a PACKAGES="uhttpd uhttpd-mod-ubus libiwinfo-lua luci-base luci-app-firewall luci-proto-ppp  luci-mod-admin-full luci-theme-bootstrap wpad luci-app-shadowsocks-libev shadowsocks-libev-ss-local -wpad-basic -ip6tables -odhcp6c -kmod-ipv6 -kmod-ip6tables -odhcpd-ipv6only curl libcurl libopenssl libustream-openssl openssl-util screen" CONFIG_IPV6=n
 #make image PROFILE=y1s PACKAGES="uhttpd uhttpd-mod-ubus libiwinfo-lua luci-base luci-app-firewall luci-proto-ppp luci-mod-admin-full luci-theme-bootstrap wpad luci-app-ddns -wpad-basic -ip6tables -odhcp6c -kmod-ipv6 -kmod-ip6tables -odhcpd-ipv6only –curl –libcurl" CONFIG_IPV6=n
